  ...
  render() {
    return (
      <nav className="d-flex justify-content-space-between navbar header sticky-top">
        <h2 onClick={this.goToCatalog} className="pointer navbar-brand ml-5 text-general"><i className="short-fall-icon fas fa-stroopwafel">
        </i>  Short Fall Brewery</h2>
        <h2 onClick={this.goToCart} className="pointer navbar-brand mr-5 text-general" ><span>
