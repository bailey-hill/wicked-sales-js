...
class ProductListItem extends React.Component {
  render() {
    return (
      <div id={this.props.productId} onClick={this.props.goToDetails} className="mobile row pointer card-width m-3 card d-flex align-items-center justify-content-center">
